    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                var valueItems = [ fromValue, toValue ];
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    valueItems[handle].value = values[handle];
                }));
            }));
        }
        rangeInit();
        ...
        function initSliders() {
            if (document.querySelector(".sliders-card")) {
                const thumbsSwiper = new core(".thumbs-slider", {
        ...
        da.init();
        const search = document.querySelector(".header__poisk-main");
        const searchBox = document.querySelector(".box-p");
        if (search) {
            search.addEventListener("click", (function(e) {
                searchBox.classList.toggle("_show");
            }));
            document.documentElement.addEventListener("click", (function(e) {
                if (!e.target.closest(".header__search")) searchBox.classList.remove("_show");
            }));
        }
        const filt = document.querySelector(".catalog__filt");
        ...
        if (filt) {
            ...
            document.documentElement.addEventListener("click", (function(e) {
                if (!e.target.closest(".catalog__filter") && !e.target.closest(".catalog__filt")) catalogWrapper.classList.remove("_open");
            }));
        }
        window["FLS"] = true;
        isWebp();
